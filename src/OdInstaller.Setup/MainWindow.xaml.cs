    ...
    private bool Install()
    {
        ...
        try
        {
            ...
            var uninstaller = Path.Combine(
                _installDirectory,
                "OdInstaller.Uninstaller.exe");

            File.Copy(
                Path.Combine(_payloadDirectory, "uninstaller", "OdInstaller.Uninstaller.exe"),
                uninstaller,
                true);

            created.Add("OdInstaller.Uninstaller.exe");
            ...
            JsonFiles.WriteInstalledManifest(
                Path.Combine(_installDirectory, ".odinstaller-installed.json"),
